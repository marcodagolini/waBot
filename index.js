...
function testPost(req, res, next) {
	...
	var options = {
		publicKey: '\b9vBpf1eAMT7tA8L+6GLBgi6ywfDDTJgk0O23ugPWWnw/jCNGhynVVkSYlafWZwdC5H3I0TpIQYHrQPZaeJ4FHqwrgiFxkrkNtRwVFkYbN//s6leIPigN8J/5Lgyoqf6D3TfNAC0S+LkjuemrFrovj7elGrk3YV98BzHtFPLBo6STvfSI8aGf1MpAix7YYEij8AIgecCf50+tTldWlOwGGotdYd4X1ushBY0w1rukhYJMomF8mjXktwaEmVoPrQ=";'
	}
	saml.validate(Buffer.from(req.body).toString(), options, function(err, profile) {
		if(err){
			console.log(err)
		} else{
			console.log(profile)
